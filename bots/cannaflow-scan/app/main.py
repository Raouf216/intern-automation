        ...
        changes.append(
            {
                ...
                "expires_at_text": first_present(current.get("expires_at_text"), current.get("expiry_date_text")),
        ...
        for change in changes:
            changes_sheet.append(
                [
                    ...
                    change.get("expires_at_text") or change.get("expiry_date_text"),
    ...
    for product in sorted(current_products, key=lambda item: normalize_space(item.get("product_name")).casefold()):
        current_sheet.append(
            [
                ...
                product.get("expires_at_text") or product.get("expiry_date_text"),
